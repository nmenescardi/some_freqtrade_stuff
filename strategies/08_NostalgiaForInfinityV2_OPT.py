...
#  [Epoch 1000 of 1000 (100%)] ||      | [Time:  4:13:05, Elapsed Time: 4:13:05]
#2021-06-01 22:07:28,157 - freqtrade.optimize.hyperopt - INFO - 1000 epochs saved to '/freqtrade/user_data/hyperopt_results/#strategy_NostalgiaForInfinityV2_2021-06-01_17-52-30.fthypt'.
#
#Best result:
#
#   577/1000:    137 trades. 95/0/42 Wins/Draws/Losses. Avg profit   4.08%. Median profit   3.63%. Total profit  653645.48997451 USDT ( 1307.29%). Avg duration 4:42:00 min. Objective: -15.48610
...
class NostalgiaForInfinityV2_OPT(IStrategy):
    INTERFACE_VERSION = 2
    ...
    buy_bb40_bbdelta_close = DecimalParameter(0.005, 0.05, default=0.041, space='buy', optimize=True, load=True)
    ...
    buy_bb20_close_bblowerband = DecimalParameter(0.8, 1.1, default=0.924, space='buy', optimize=True, load=True)
    buy_bb20_volume = IntParameter(18, 34, default=21, space='buy', optimize=True, load=True)
    buy_rsi_diff = DecimalParameter(36.0, 54.0, default=50.648, space='buy', optimize=True, load=True)

    sell_rsi_bb = DecimalParameter(60.0, 80.0, default=60.397, space='sell', optimize=True, load=True)
    sell_rsi_main = DecimalParameter(72.0, 90.0, default=89.568, space='sell', optimize=True, load=True)
    sell_rsi_2 = DecimalParameter(72.0, 90.0, default=87.786, space='sell', optimize=True, load=True)
    sell_ema_relative = DecimalParameter(0.005, 0.1, default=0.03, space='sell', optimize=False, load=True)
    sell_rsi_diff = DecimalParameter(0.0, 5.0, default=1.488, space='sell', optimize=True, load=True)
